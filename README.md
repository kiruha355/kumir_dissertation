...
Проект показывает, как простую картинку можно представить в виде матрицы и превратить ее в программу для исполнителя Робот. Все в мире можно сделать на КуМире.
...
3. Создай поле не меньше `56 x 42`.
